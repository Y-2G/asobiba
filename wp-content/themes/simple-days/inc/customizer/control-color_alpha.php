...
class Simple_Days_Color_Alpha_Custom_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
      ...
      wp_localize_script( 'wp-color-picker-alpha', 'wpColorPickerL10n', array(
        'clear' => __( 'Clear','simple-days' ),
        'clearAriaLabel' => __( 'Clear color','simple-days' ),
        'defaultString' => __( 'Default','simple-days' ),
        'defaultAriaLabel' => __( 'Select default color','simple-days' ),
        'pick' => __( 'Select Color','simple-days' ),
        'defaultLabel' => __( 'Color value','simple-days' ),
      ) );
